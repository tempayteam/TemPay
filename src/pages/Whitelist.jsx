...
const Whitelist = () => {
  ...
  const [hasLikedAndReposted, setHasLikedAndReposted] = useState(false);
  ...
  const handleFollowX = () => {
    window.open("https://x.com/tempay_tempo", "_blank");
  ...
  const handleVerifyUsername = () => {
    ...
    if (val.includes("@")) {
      setStatus("error");
      setErrorMsg("Username should not contain @");
      return;
    }
    if (val.length <= 1) {
      setStatus("error");
  ...
  const handleSubmit = () => {
    ...
    if (!isValidWallet(addr)) {
      setStatus("error");
      setErrorMsg("Invalid wallet address. Please enter a valid EVM address.");
      return;
    }
  ...
  return (
    <div className="Whitelist-page-container">
      {/* NAV */}
          ...
          <div className="wl-card">
            ...
            {status === "success" ? (
              ...
              <div className="wl-form-container">
                {/* STEP 1: FOLLOW ON X */}
                {!hasFollowedX && (
                  <div className="wl-step-content">
                    <button className="wl-btn-social-x" onClick={handleFollowX}>
                      Follow Tempay
                      <svg
                        width="18"
                        height="18"
                    ...
                    <p className="wl-step-hint">Step 1: Follow Tempay</p>
                  </div>
                )}

                {/* STEP 2: LIKE & REPOST */}
                {hasFollowedX && !hasLikedAndReposted && (
                  <div className="wl-step-content">
                    <button className="wl-btn-social-x" onClick={handleLikeAndRepost}>
                      Like & Repost
                      <svg
                        width="18"
                        height="18"
                    ...
                    <p className="wl-step-hint">Step 2: Like & Repost</p>
                  </div>
                )}

                {/* STEP 3: VERIFY USERNAME */}
                {hasFollowedX && hasLikedAndReposted && !isUsernameVerified && (
                  <div className="wl-step-content">
                    <div className="wl-form-col">
                      ...
                      {status === "error" && errorMsg && (
                        <p className="wl-input-error">{errorMsg}</p>
                      )}
                      <button
            ...
            {!status === "success" && (
              <p className="wl-privacy">
                Your data is stored securely. Nothing else.
              </p>
            )}
